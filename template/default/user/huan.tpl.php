        	...
        	<div class="adminright">
                ...
                <?php foreach($huan as $r){?>
                   <table width="770" border="0" cellspacing="0" cellpadding="0" class="admin_table_fx">
                      <tr>
                        <td width="105" height="90" align="center"><a target="_blank" href="<?=u('huan','view',array('id'=>$r['id']))?>"><img src="<?=$r['img']?>" alt="<?=$r['title']?>" /></a></td>
                        <td width="665">
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="27" colspan="4"><strong>商品名：</strong><a target="_blank" href="<?=u('huan','view',array('id'=>$row['id']))?>"><?=$r["title"]?></a></td>
                            <td width="18%" height="27"><?=date('Y-m-d H:i:s',$r['addtime'])?></td>
                          </tr>
                          <tr>
                            <td width="16%" height="34">消费：<?php if($r['mode']==1){echo $r["money"].'金额';}else{echo $r["jifen"].'积分';}?> </td>
