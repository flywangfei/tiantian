...
<table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td><input onfocus="$(this).next('img').attr('src','comm/showpic.php?a='+Math.random())" name="captcha" type="text" id="captcha" size="6" maxlength="4" style="width:50px;" class="ddinput"/>&nbsp;&nbsp;<?=yzm()?></td>
      ...
      <div class="register_right">
          <div class="register_right_1">
              ...
              <?php foreach($apps as $row){?>
                <li><a class="<?=$row['code']?>" href="<?=u('api',$row['code'],array('do'=>'go'))?>"><?=$row['title']?></a></li>
              <?php }?>              
              </ul>
          </div>
          <?php }?>
