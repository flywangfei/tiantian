      ...
      <?php }?>
		...
		<div id="m_cat">
			...
			<dd>
				...
				<div class="box">
					<a href="<?=u('paipai','list',array('q'=>'成人'))?>" target="_blank" class="big">成人</a>
					<a href="<?=u('paipai','list',array('q'=>'杜蕾斯'))?>" target="_blank">杜蕾斯</a>
					<a href="<?=u('paipai','list',array('q'=>'充气娃娃'))?>" target="_blank">充气娃娃</a>
					<a href="<?=u('paipai','list',array('q'=>'制服诱惑'))?>" target="_blank">制服诱惑</a>
				</div>
				<div class="clear"></div>
			</dd>
			</dl>
