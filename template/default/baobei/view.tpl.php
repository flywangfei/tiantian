...
$(function(){
	...
	$('#noComment').click(function(){
	    alert(errorArr[11]);
		window.location='<?=SITEURL.'/'.u('user','login')?>&from='+encodeURIComponent(location.href);
	});
  ...
  <div class="good" style="padding-top:15px">
    <div class="good-left">
      ...
      <a name="p"></a>
        ...
        <span style="float:left; padding-left:15px; color:#669900; font-family:黑体; font-size:14px">￥<?=$baobei['price']?><?php if($baobei['commission']>0){?>[<span style="font-size:11px">返</span>￥<?=$baobei['fxje']?>]<?php }?></span></div>
...
<a title="分享到新浪微博" class="bshare-sinaminiblog">新浪微薄</a>
<a title="分享到人人网" class="bshare-renren">人人网</a>
<a title="分享到腾讯微博" class="bshare-qqmb">腾讯微薄</a>
