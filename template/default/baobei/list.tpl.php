...
<?=AD(11)?>
  ...
  <div class="good">
    <div class="goods-top">
      <ul>
        <li <?php if($sort=='id'){?> class="cur"<?php }?>><a href="<?=u('baobei','list',array('sort'=>'id','cid'=>0,'page'=>1))?>">最新宝贝</a></li>
        <li <?php if($sort=='hart'){?> class="cur"<?php }?>><a href="<?=u('baobei','list',array('sort'=>'hart','cid'=>0,'page'=>1))?>">最热宝贝</a></li>
      </ul>
    </div>
    <!-- 产品列表 开始 -->
    <div class="goods">
