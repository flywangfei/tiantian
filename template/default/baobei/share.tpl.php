...
function getComm(){
	if(commission>=0){
		...
		clearInterval(getCommProcess);
	} 
}
getCommProcess = setInterval("getComm()", 100);
...
<div class="LightBox" id="LightBox"></div><div id="jumpbox" show="0" class="jumpbox"><div class="top_left"></div><div class="top_center"></div><div class="top_right"></div><div class="middle_left"></div><div class="middle_center"><div class="close"><a></a></div><p style="height:22px"></p><div class="contain">
<div id="shareHtml">
<div id="shareContain">
<form id="shaiForm">
    <div class="share_cat">
