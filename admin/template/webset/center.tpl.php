  ...
  <div class="c_left">
    ...
    <div class="box_l">
        ...
        <ul>
		  ...
		  <li><a href="http://bbs.duoduo123.com/thread.php?fid=39" target="_blank">提交问题</a></li>
      ...
      <div class="box_l">
		...
		<script>
		countDown(<?php $t=intval(TIME)-intval($webset['taobao_session_time']);if($t>$session_time_last){echo $session_time_last;}else{echo $t;}?>,function(msg) {document.getElementById('sessiontime').innerHTML = msg;});
		</script>
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  ...
		  <li>已支出：<b style="color:#009900"><?=$tixian_sum?> 元</b></li>
  ...
  <div class="c_right">
    <div class="box_l">
	 	  <table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7;">
            ...
            <tr>
              <td colspan="2" valign="top"><span class="left_txt">&nbsp;<img src="images/ts.gif" width="12" height="12" /> 版本：<span class="banben">V8</span>_UTF-8 更新日期：</span> <span class="S3"><?=$banben?></span> <a style="text-decoration:underline" href="<?=u('upgrade','index')?>">检查版本</a>
        ...
        <div class="box_l">
	 	  <table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7;">
            ...
            <tr>
              <td colspan="2" valign="top" style="padding:3px 10px;"><div align="left"><span style="line-height:25px;">授权网址： <span style="color:#FF0000"><?=$auth_arr['url']?$auth_arr['url']:'本地测试'?></span><br/>开始时间：<?=date('Y-m-d',$auth_arr['stime'])?>&nbsp;&nbsp;到期时间：<?=date('Y-m-d',$auth_arr['etime'])=='2038-01-01'?'终生授权':date('Y-m-d',$auth_arr['etime'])?><br/><a href="<?=u(MOD,ACT,array('duoduoauthget'=>'1'))?>">从新获取</a>&nbsp;&nbsp; <a href="http://auth.duoduo123.com/ckurl.php?url=<?=get_domain()?>" target="_blank"><img src="images/biz.gif" width="102" height="23" border="0" align="absmiddle" /></a></span><span style="line-height:25px;"></span></div></td>
            </tr>
          </table>
	 	</div>
        <div class="box_l">
