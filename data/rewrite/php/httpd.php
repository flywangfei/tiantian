...
RewriteRule ^/<?=$cur_path?><?=$alias['baobei/list'][0]?>/<?=$alias['baobei/list'][1]?>-(.*)-(\d+)\.html$ /<?=$cur_path?>index\.php\?mod=baobei&act=list&cid=$1&page=$2
RewriteRule ^/<?=$cur_path?><?=$alias['baobei/list'][0]?>/<?=$alias['baobei/list'][1]?>-(.*)\.html$ /<?=$cur_path?>index\.php\?mod=baobei&act=list&cid=$1
