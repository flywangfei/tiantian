...
<div class="right_sk">
	<h6><a href="<?=$the_goods['jump']?>" target="_top"><?=$the_goods['title']?></a>
	</h6>
	<div class="pic"><a href="<?=$the_goods['jump']?>" target="_top"><?=html_img($the_goods["pic_url"],1,$the_goods["name"])?></a>
	</div>
	<div class="icon_fan">
	</div>
    ...
    <?php }?>
	<div class="sk_submit"><a  target="_top" href="<?=$the_goods['jump']?>&dduserid=<?=$uid?>">购物拿返现</a>
	</div>
</div>
<?php }else{?>
<!--第一件end-->
